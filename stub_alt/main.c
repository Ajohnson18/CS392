...
void remove_first_word(linked_list *list, char *word) {
    remove_first(list, (void *)word, str_cmp);
}
...
int main() {
    ...
    remove_first_word(list, "computer");
    print_list(list, print_str);

    remove_first_word(list, "apple");
    print_list(list, print_str);

    remove_first_word(list, "zebra");
    print_list(list, print_str);

    remove_first_word(list, "noexists");
    print_list(list, print_str);
